...
function BuyMenu:CreateItems()
    ...
    self.items = {
        [self.types.Vehicle] = {
            {"Land", "Air", "Sea", "Bike", "Car", "Sportcar", "Jeep", "Pickup", "Bus", "Truck", "Heavy", "Tractor", "Heli", "Plane", "Boat"},
            ["Land"] = {
        ...
        [self.types.Weapon] = {
            {"One-handed", "Two-handed", "Right Hand", "Left Hand", "Primary"},
            ["One-handed"] = {
